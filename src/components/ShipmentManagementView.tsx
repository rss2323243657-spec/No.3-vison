            ...
            <tbody className="divide-y divide-slate-200">
              {filteredShipments.map((shp) => {
                ...
                return (
                  ...
                  >
                    {/* 1. Sticky Checkbox */}
                    <td className={`p-3 text-center w-10 min-w-[40px] max-w-[40px] sticky left-0 z-10 ${stickyBg} border-b border-slate-100`}>
                      <input
                        type="checkbox"
                        checked={isSelected}
                    ...
                    <td className={`p-3 w-[170px] min-w-[170px] max-w-[170px] sticky left-[40px] z-10 ${stickyBg} border-b border-slate-100`}>
                      <button
                        onClick={() => onSelectShipment(shp.id)}
                        className="font-mono font-bold text-blue-600 hover:underline block text-left truncate max-w-[155px]"
                        title={shp.id}
                      >
                        {shp.id}
                      </button>
                    ...
                    <td className={`p-3 w-[210px] min-w-[210px] max-w-[210px] sticky left-[210px] z-10 ${stickyBg} border-b border-slate-100`}>
                    ...
                    {/* 4. Sticky FC Warehouse */}
                    <td className={`p-3 w-[100px] min-w-[100px] max-w-[100px] sticky left-[420px] z-10 ${stickyBg} font-mono text-slate-700 border-b border-slate-100 border-r border-slate-200 shadow-[4px_0_8px_-2px_rgba(0,0,0,0.06)]`}>
                      {shp.fc}
                    </td>
